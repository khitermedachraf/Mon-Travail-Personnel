...
int main(int argc, char *argv[])
{
   ...
   do
   {
        ...
        printf("-1- Restauration \n\n\t **** PS: Si vous ne sauvegarder pas avant de fermer  ") ;
        printf("le programme ,vous risquez de perdre vos donnees ****\n");
        ...
        printf("8- Affichage  et sauvgarde de DATA-BASE .\n") ;
        printf("99- Exit .\n\n");
...
case  5 :
    printf("\n\n");
    printf("1-suggestion par octet :\n");
    printf("2-suggestion par followers :\n");
    printf("     ####################Votre choix est : ");
