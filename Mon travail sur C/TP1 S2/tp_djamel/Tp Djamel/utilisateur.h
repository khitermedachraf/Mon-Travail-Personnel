...
void suggestion_par_octet () ; /// pour suggerer des utilisateurs  par raport au centre d' interet .
void suggestion_par_followers();///pour suggerer des utilisateurs  par raport aux followers.
void tableau_followers(int* t,int tai,int nb_followers,utilisateur* user);///la fontion qui fait le tri du tableau récupéré de la fonction suggestion_par_followers.
